...
import esg.esg_schema as esg_schema, eq_research.morning_star_eq_research as morning_star_eq_research
...
async def extract_information(docs):
    ...
    chain = create_extraction_chain(
        llm,
        morning_star_eq_research.schema,
        encoder_or_encoder_class="json",
        validator=morning_star_eq_research.extraction_validator,
...
# combined = chunks[:10] + chunks[20:30] + chunks[40:50]
combined = chunks

import asyncio

print ('Extracting information')
esg_info = asyncio.run(extract_information(combined))

esg_info.to_csv("./data/output/raw/eq_research_information.csv",index=False)